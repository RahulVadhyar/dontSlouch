...
class SettingsTab:
    def __init__(self, notebook):
        ...
        self.settingsLabel = ttk.Label(self.settingsFrame, text = 'Settings', font= ('Arial', 40))
        self.settingsLabel.pack(padx=10, pady=10, anchor = 'w')
        
        #theme
        self.themeFrame = ttk.Frame(self.settingsFrame)
        self.themeLabel = ttk.Label(self.themeFrame, text = 'Theme', font= ('Arial', 20))
        ...
        self.device_label = ttk.Label(self.device_frame, text = 'Device', font= ('Arial', 20))
